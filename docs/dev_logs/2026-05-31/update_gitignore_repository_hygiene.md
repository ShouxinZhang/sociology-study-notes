...
| `docs/architecture/repository-structure.md` | 更新 `.gitignore` 的职责说明，并登记 `docs/dev_logs/2026-05-31/` 日期分区。 |
| `docs/dev_logs/2026-05-31/README.md` | 新增当天开发日志索引。 |
| `docs/dev_logs/2026-05-31/update_gitignore_repository_hygiene.md` | 新增本次变更记录。 |
