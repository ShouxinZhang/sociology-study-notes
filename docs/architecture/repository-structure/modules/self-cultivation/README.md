# self-cultivation/ 模块索引

自我修炼、长篇阅读、论文研读与内容实验的主内容域。
...
| Key | 仓库路径 | 说明 | 详情 |
|---|---|---|---|
| `self-cultivation.talent-exploration` | `self-cultivation/天赋探索/` | 面向个人能力结构、潜在优势与后续自我盘点问题的分析子模块 | [进入](talent-exploration.md) |
| `self-cultivation.classical-chinese` | `self-cultivation/古文学习/` | 古文原文与现代汉语译文练习子模块 | [进入](classical-chinese.md) |
| `self-cultivation.book-reading` | `self-cultivation/book_reading/` | 书籍阅读与长篇文献转写/翻译工作区 | [进入](book-reading.md) |
| `self-cultivation.virtual-social-circle` | `self-cultivation/虚拟朋友圈/` | 面向“虚拟朋友圈”系列内容、时间线随笔与社交素材的独立子模块 | [进入](virtual-social-circle.md) |
...
| `self-cultivation.entertainment-sandbox` | `self-cultivation/娱乐沙盒/` | 娱乐向连载小说、沙盒脑洞、数学未解问题、随机模拟与个人音乐数据归档等趣味知识及轻量创作实验区 | [进入](entertainment-sandbox.md) |
