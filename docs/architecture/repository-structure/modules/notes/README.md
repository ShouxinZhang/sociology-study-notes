...
学习笔记与思考成果的主内容域。本页只保存直属分类的查询键。

| Key | 仓库路径 | 说明 | 详情 |
|---|---|---|---|
| `notes.methodology-academic-strategy` | `notes/Methodology_Academic_Strategy/` | 学习方法、数学学术、效率策略相关笔记。 | [Methodology_Academic_Strategy](methodology-academic-strategy.md) |
| `notes.qiushi-study-materials` | `notes/Qiushi_Study_Materials/` | 求是学习材料的结构化解读与政策学习笔记。 | [Qiushi_Study_Materials](qiushi-study-materials.md) |
