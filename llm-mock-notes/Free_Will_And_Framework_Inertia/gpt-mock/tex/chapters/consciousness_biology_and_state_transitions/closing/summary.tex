...
state-space problems. The chapter therefore contributes credibility, not
closure: it gives the manuscript a real bridge to biology while preserving a
clear boundary against overclaiming.
\end{summarybox}
